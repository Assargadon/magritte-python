...
from descriptions.tests.MARelationDescriptionTest import TestProperties_of_MARelationDescription
from descriptions.tests.MADescriptionTest import MADescription_ValidationTest
from errors.MARequiredError import MARequiredError


class TestProperties_of_MAToManyRelationDescription(TestProperties_of_MARelationDescription):
    def get_description_instance_to_test(self):
        return MAToManyRelationDescription()


class MAToMany_ValidationTest(MADescription_ValidationTest):
    def setUp(self):
